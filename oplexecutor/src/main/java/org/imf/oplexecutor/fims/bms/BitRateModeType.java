...
/**
 * <p>Java class for BitRateModeType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="BitRateModeType">
...
public enum BitRateModeType {
    ...
    public static BitRateModeType fromValue(String v) {
        for (BitRateModeType c: BitRateModeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
