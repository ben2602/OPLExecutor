...
@Provider
public class TransformResponseWriter implements MessageBodyWriter<TransformResponseType>{

	@Override
	public long getSize(TransformResponseType t, Class<?> type, Type genericType, Annotation[] annotations,
			MediaType mediaType) {
		return -1;
	}
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return TransformResponseType.class.isAssignableFrom(type);
	}

	@Override
	public void writeTo(TransformResponseType t, Class<?> type, Type genericType, Annotation[] annotations,
		...
		try {   
			   ...
			   JAXBElement<TransformResponseType> tA = factory.createTransformAck(t);
			  
			   marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);
			   marshaller.marshal(tA, entityStream);
