...
@Provider
public class ManageJobRequestReader implements MessageBodyReader<ManageJobRequestType>{

	@Override
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return ManageJobRequestType.class.isAssignableFrom(type);
	}

	@Override
	public ManageJobRequestType readFrom(Class<ManageJobRequestType> type, Type genericType, Annotation[] annotations,
		...
		try {
			   ...
			   JAXBElement<ManageJobRequestType> mJR = (JAXBElement<ManageJobRequestType>) um.unmarshal(entityStream);
